        ...
        try {
            ...
            for (int i = 0; i < movie_list_size; i++) {
                ...
                if (dateString != null && !dateString.equals("null")) {
                    ...
                    manager.insertMovieInfo(title,dateString,rating);
            ...
            broadcastIntent.setAction(com.example.cs3714.service_brodacast_receiver_db_demo.MainActivity.ResponseReceiver.ACTION_RESP);
