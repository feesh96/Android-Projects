...
/**
 * Created by Matthew on 1/3/2017.
 */
...
public class FeedAdapter<T extends FeedEntry> extends ArrayAdapter {
    ...
    public FeedAdapter(Context context, int resource, List<T> application) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {    // To avoid creating a new view every time
